...
export async function createEncounter(patientId, payload) {
  const response = await fetch(`${PATIENT_SERVICE_URL}/api/patients/${patientId}/encounters`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload)
  });
...
export async function createObservation(encounterId, payload) {
  const response = await fetch(`${PATIENT_SERVICE_URL}/api/encounters/${encounterId}/observations`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload)
  });
...
export async function createCondition(patientId, payload) {
  const response = await fetch(`${PATIENT_SERVICE_URL}/api/conditions/patient/${patientId}`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload)
  });
...
export async function createClinicalNote(patientId, payload) {
  const response = await fetch(`${PATIENT_SERVICE_URL}/api/patients/${patientId}/notes`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload)
  });
